...
class SliderRecommendPerson extends Component {
  ...
  render() {
    ...
    return (
      <div className="container mt-2 mt-md-3 recommend-person-container" onMouseOver={this.pausePlay} onFocus={this.pausePlay} onMouseOut={this.autoplay} onBlur={this.autoplay}>
...
SliderRecommendPerson.propTypes = {
